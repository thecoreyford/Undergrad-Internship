/* ------------------------------------------------------------
name: "ExtendedKarplusStrong"
Code generated with Faust 2.5.34 (https://faust.grame.fr)
Compilation options: cpp, -scal -ftz 0
------------------------------------------------------------ */

#ifndef  __ExtendedKarplusStrong_H__
#define  __ExtendedKarplusStrong_H__
...
float ExtendedKarplusStrong_faustpower2_f(float value) {
	return (value * value);
	
}

#ifndef FAUSTCLASS 
#define FAUSTCLASS ExtendedKarplusStrong
#endif
#ifdef __APPLE__ 
...
class ExtendedKarplusStrong : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "ExtendedKarplusStrong");
		...
		m->declare("name", "ExtendedKarplusStrong");
	...
	virtual ExtendedKarplusStrong* clone() {
		return new ExtendedKarplusStrong();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("ExtendedKarplusStrong");
		...
		ui_interface->addHorizontalSlider("Pluck Position", &fHslider3, 5.0f, 0.0f, 10.0f, 0.00100000005f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow12 = (2.0f * (1.0f - (1.0f / ExtendedKarplusStrong_faustpower2_f(fSlow0))));
		float fSlow13 = (((fSlow1 + -1.41421354f) / fSlow0) + 1.0f);
		float fSlow14 = float(fButton0);
		float fSlow15 = (fConst2 * float(fHslider3));
		float fSlow16 = floorf(fSlow15);
		float fSlow17 = (fSlow16 + (1.0f - fSlow15));
		int iSlow18 = int(fSlow15);
		int iSlow19 = min(65537, max(0, iSlow18));
		float fSlow20 = (fSlow15 - fSlow16);
		int iSlow21 = min(65537, max(0, (iSlow18 + 1)));
		for (int i = 0; (i < count); i = (i + 1)) {
			fRec1[0] = (((fSlow6 * fRec0[((IOTA - iSlow8) & 4095)]) + (fSlow9 * fRec0[((IOTA - iSlow10) & 4095)])) - (fSlow11 * ((fSlow12 * fRec1[1]) + (fSlow13 * fRec1[2]))));
			fVec0[0] = fSlow14;
			int iTemp0 = ((fSlow14 - fVec0[1]) > 0.0f);
			iVec1[(IOTA & 2047)] = iTemp0;
			fRec0[(IOTA & 4095)] = (((fSlow3 * (fRec1[2] + (fRec1[0] + (2.0f * fRec1[1])))) + float(iTemp0)) - ((fSlow17 * float(iVec1[((IOTA - iSlow19) & 2047)])) + (fSlow20 * float(iVec1[((IOTA - iSlow21) & 2047)]))));
...
ExtendedKarplusStrong	DSP; //declared global by faust
