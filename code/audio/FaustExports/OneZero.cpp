...
#ifndef  __OneZero_H__
#define  __OneZero_H__
...
class OneZero : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("OneZero");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fVec0[0] = fTemp0;
			float fTemp1 = (fTemp0 + (fSlow0 * fVec0[1]));
...
OneZero	DSP; //declared global by faust
